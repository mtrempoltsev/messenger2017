...
namespace m2 {
    ...
    MessageManager::MessageStory MessageManager::GetMessageStory(const std::string& username) const {
    ...
    void MessageManager::SaveMessageStory(const MessageStory& ms, const std::string& contactName) {
        std::string defaultPath = GetDefaultPath();
