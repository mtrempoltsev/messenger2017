...
int main() {
    ...
    m2::crypto::pki::OpenSSL_RSA_CryptoProvider orca {
                    "-----BEGIN PUBLIC KEY-----\n"
    ...
    m2::crypto::sym::OpenSSL_AES_CryptoProvider aes(192, "mypass", "mysalt");
    ...
    auto m = m2::crypto::pki::OpenSSL_RSA_CryptoProvider::make(2048);
